...
! function(e, n, t) {
    ...
    function h(e, n, s, o) {
        ...
        for (c = e.length, p = 0; c > p; p++)
            if (h = e[p], v = k.style[h], a(h, "-") && (h = f(h)), k.style[h] !== t) {
                if (o || r(s, "undefined")) return l(), "pfx" == n ? h : !0;
                try {
                    k.style[h] = s
                } catch (y) {}
                if (k.style[h] != v) return l(), "pfx" == n ? h : !0
            }
        return l(), !1
    }
    ...
    var x = n.documentElement,
        ...
        b = "Moz O ms Webkit",
        T = C._config.usePrefixes ? b.toLowerCase().split(" ") : [];
    C._domPrefixes = T;
    ...
    var E = C._config.usePrefixes ? b.split(" ") : [];
    C._cssomPrefixes = E;
    ...
    C.testAllProps = v, C.testAllProps = g, Modernizr.addTest("csstransforms", function() {
        ...
        if (e && (!n || "webkitPerspective" in x.style)) {
            ...
            Modernizr.supports ? t = "@supports (perspective: 1px)" : (t = "@media (transform-3d)", n && (t += ",(-webkit-transform-3d)")), t += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}", N(r + t, function(n) {
                e = 7 === n.offsetWidth && 18 === n.offsetHeight
            })
        }
        return e
    }), s(), o(y), delete C.addTest, delete C.addAsyncTest;
